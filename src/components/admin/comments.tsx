      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full h-12 pl-12 pr-4 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-[15px] placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 dark:focus:ring-primary/30 dark:focus:border-primary/50 transition-all shadow-sm hover:shadow-md dark:shadow-none ${isUsernameFieldDisabled
        ...
        <div className="flex items-center justify-between h-12 bg-white dark:bg-card-dark border border-slate-200 dark:border-slate-800 rounded-xl px-4">
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${groupByConfession
                ? "bg-primary"
                : "bg-slate-300 dark:bg-slate-600"
              }`}
          >
            <span
              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${groupByConfession ? "translate-x-5" : "translate-x-1"
                }`}
            />
          </button>
        </div>
          ...
          confessionGroups.map((group) => (
            ...
            >
              ...
              <div className="flex items-center justify-start gap-4 border-t border-gray-100 dark:border-white/10 pt-3">
                ...
                <button
                  className={`flex items-center gap-1.5 transition-colors ${expandedConfessions.has(group.confessionId)
          ...
          filteredComments.map((comment) => (
            ...
            >
              ...
              <div className="flex items-center justify-start gap-4 border-t border-gray-100 dark:border-white/10 pt-3">
                ...
                <button
                  className={`flex items-center gap-1.5 transition-colors ${expandedReplies.has(comment._id)
                      ? "text-primary dark:text-primary"
                      : "text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary"
                    }`}
