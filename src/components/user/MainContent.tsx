          ...
          <section className="w-full overflow-x-auto no-scrollbar pb-2">
            <div className="flex gap-4 min-w-min">
              ...
              {DUMMY_STORIES.map((story) => (
                ...
                >
                  <div
                    className={`p-[3px] rounded-full ${story.active
                  ...
                  <span
                    className={`text-xs font-medium ${story.active
                    ...
                    >
                      <div className="p-4 flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-4 mt-2 text-slate-500 dark:text-slate-400">
                          <button
                            className={`flex items-center gap-1.5 transition-colors ${isLiked ? "text-primary" : "hover:text-pink-500"
                              }`}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
              {MOOD_OPTIONS.map((m) => (
                <button
                  ...
                  className={`rounded-2xl border px-3 py-3 text-left transition-all ${poolMood === m.value
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`material-symbols-outlined text-[18px] ${poolMood === m.value
