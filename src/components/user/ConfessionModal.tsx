    ...
    return (
      <div key={item._id} className="flex gap-3 items-start">
        ...
        <div className="flex-1">
          <div
            className={`${isOP ? "bg-primary/5 border border-primary/10" : "bg-gray-100"
              } p-3 rounded-[18px] rounded-tl-none inline-block max-w-full`}
          >
            <div className="flex items-center gap-2 mb-0.5">
              <span
                className={`text-xs font-bold ${isOP ? "text-primary" : "text-gray-900"
                  }`}
              >
          ...
          <div className="flex items-center gap-4 mt-1.5 ml-2">
            ...
            <div className="flex items-center gap-1 ml-auto mr-1">
              <span
                className={`material-symbols-outlined text-[12px] ${item.isLikedByMe
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar bg-white">
          <div className="px-6 py-6 border-b border-gray-100">
            ...
            <div className="flex items-center gap-6 pt-2">
              <button
                className={`flex items-center gap-2 group transition-colors ${confession.isLikedByMe
                    ? "text-primary"
              ...
              >
                <span
                  className={`material-symbols-outlined text-[22px] group-hover:scale-110 ${confession.isLikedByMe ? "fill-current" : ""
                    }`}
                >
